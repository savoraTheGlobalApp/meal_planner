...
export function Home() {
	...
	return (
		<div className="space-y-6">
			{/* Preferences Card */}
			<div className="card-gradient bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200">
			...
			{hasPreferences && (
				<div className="card-gradient bg-gradient-to-br from-emerald-50 to-teal-100 border-emerald-200">
					<div className="flex items-start gap-4">
						...
						<div className="flex-1">
							...
							<div className="flex flex-col sm:flex-row gap-3">
								<Link 
									to="/menu/weekly" 
									className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-emerald-600 hover:to-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
								>
									<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								...
								<Link 
									to="/menu/daily/0" 
									className="inline-flex items-center gap-2 bg-white text-emerald-600 border-2 border-emerald-200 px-6 py-3 rounded-xl font-semibold hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
								>
									<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
